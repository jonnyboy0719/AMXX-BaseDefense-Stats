...
$country = array(
	'00' => 'Unknown',
	'err' => 'Error: Missing country code',
...
?>
		<table id="bdefstats_table" border="0" cellpadding="8" cellspacing="1" width="100%">
			<thead>
				<tr>
					...
					<th class="toprow">Legerity</th>
					<th class="toprow">Precision</th>
					<th class="toprow">Toughness</th>
					<th class="toprow">Sorcery</th>
			...
			<tr align="center" style="height: 30px;">
				...
				<td class="row2" align="left" width="100%">
						...
						else
						{
							...
							$ReplaceText = str_replace("^0", "</span>", $ReplaceText);
							$ReplaceText = str_replace("^9", "</span>", $ReplaceText);
							$ReplaceText = str_replace("^1", "</span>", $ReplaceText);
							$ReplaceText = str_replace("^2", "</span><span style='color:red'>", $ReplaceText);
							$ReplaceText = str_replace("^3", "</span><span style='color:green'>", $ReplaceText);
							$ReplaceText = str_replace("^4", "</span><span style='color:blue'>", $ReplaceText);
							$ReplaceText = str_replace("^5", "</span><span style='color:orange'>", $ReplaceText);
